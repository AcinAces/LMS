      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-slate-950/70 backdrop-blur-xl border-b border-white/5 text-slate-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {username ? (
              <div className="relative flex items-center border-l border-white/10 pl-2 lg:pl-4">
                <button 
                  onClick={() => setShowDropdown(!showDropdown)}
                  className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 bg-slate-800/50 hover:bg-slate-800 border border-slate-700/80 hover:border-emerald-500/50 rounded-lg text-sm font-medium text-slate-200 hover:text-emerald-400 transition-all shadow-sm"
                >
