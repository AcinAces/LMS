  ...
  useEffect(() => {
    const fetchLessonData = async () => {
      try {
        ...
        // 2. Fetch the user's progress for this course's lessons
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              {nextLesson ? (
                ...
                <Link
                  ...
                  className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg shadow-lg shadow-blue-500/20 transition-all"
                >
                  Finish Course &#10003;
                </Link>
              )}
