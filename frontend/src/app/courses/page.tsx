...
export default function CoursesPage() {
  ...
  const theoryCourses = filteredCourses.filter(c => !c.courseType || c.courseType === 'Theory');
  const contestCourses = filteredCourses.filter(c => c.courseType === 'Contest');
    ...
    <div className="relative min-h-[calc(100vh-4rem)] pt-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        {loading ? (
          ...
          <div className="animate-fade-in-up delay-100 space-y-12">
